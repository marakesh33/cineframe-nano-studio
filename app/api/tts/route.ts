...
function addExpressiveTags(script: string) {
  return `[quiet, calm, intimate, gently ease into the first words, no hard attack, speaking from personal experience, connect related sentences naturally without resetting the voice, never leave a long empty gap] ${script}`;
}
